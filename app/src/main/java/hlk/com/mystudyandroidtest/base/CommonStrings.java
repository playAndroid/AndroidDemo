...
public class CommonStrings {
    public static final String[] MAIN_LIST = {"RxJavaDemo", "RetrofitDemo", "RxJava&RetrofitDemo", "RecyclerDemo", "ActivityDemo"
            ...
            "otto", "IMDemo", "内存优化与监控", "自定义View","MVP","Scheme","注解","Socket","动画"};
}
